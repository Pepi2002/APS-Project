...
from OtherTechnologiesPepi.NumberGenerator import CSPRNGGenerator
...
class HybridCrypto:
    ...
    def encrypt(self, plaintext: bytes, recipient_public_key_pem: bytes) -> bytes:
        sym_key = self.number_gen.generate_session_key()    # usa la classe CSPRNGGenerator
        nonce = self.number_gen.generate_key_material(16)   # 16 byte nonce per AES-CTR
